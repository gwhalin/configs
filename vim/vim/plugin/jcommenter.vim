...
" let b:jcommenter_class_author = '$Author: $'
...
" let b:jcommenter_class_version = '$Revision: $ $Date: $'
...
" let b:jcommenter_file_author = '$Author: $'
...
" to remove it.
let b:jcommenter_file_copyright = 'copyright (c) 2007 meetup, inc'
...
function! JCommenter_OwnFileComments()
  call append(0, '/**')
  call append(1, ' * ' . bufname("%"))
  call append(2, ' *')
  call append(4, ' * @version greg whalin')
  call append(5, ' * copyright (c) 2007 meetup, inc')
  call append(8, ' */')
endfunction
